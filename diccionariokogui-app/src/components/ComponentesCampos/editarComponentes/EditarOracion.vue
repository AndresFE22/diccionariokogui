<template>
  ...
  export default {
    ...
    methods: {
      obteneroraciones() {
        axios
          .get('https://cuentaapi.pythonanywhere.com/apik/showtableo')
          .then((response) => {
      ...
      eliminarOracion(id) {
        axios
          .delete(`https://cuentaapi.pythonanywhere.com/apik/oraciones/${id}`)
          .then((response) => {
      ...
      openModal(id) {
        axios
          .get(`https://cuentaapi.pythonanywhere.com/apik/oraciones/${id}/image`)
          .then((response) => {
